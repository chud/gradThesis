...
%% --- UHCL Approval page
\addtotoc{Signatures}{\vspace{1em}}  % Add the "Abstract" page entry to the Contents
\signatures
...
\input{Chapters/ProblemDefinition} % Problem Definition

\input{Chapters/SystemDesign} % System Design

\input{Chapters/SecuringTheData} % Securing the Data
\input{Chapters/ThreatsAndAttacks} % threats and attacks
...
\input{Appendices/ImplementationDetails}	% Implementation Details
\input{Appendices/Glossary}	% Glossary
\input{Appendices/Provisioning} % Provisioning
